...
public class EventModelImpl extends BaseModelImpl<Event> implements EventModel {
    ...
    public static final String TABLE_SQL_CREATE = "create table Event_Event (eventId LONG not null primary key,name VARCHAR(75) null,description VARCHAR(75) null,date_ DATE null,companyId LONG,groupId LONG,userId LONG,createDate DATE null,modifiedDate DATE null,locationId LONG)";
